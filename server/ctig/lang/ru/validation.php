...
return [
    ...
    */
    ...
    'prohibited_if_accepted' => 'Поле :attribute запрещено, если принято значение :other.', 
    ...
    'required_if_declined' => 'Поле :attribute обязательно для заполнения, если параметр :other отключен.',
    ...
    */
    ...
    'attributes' => [
        ...
        'examiners.*' => 'экзаменатор',
        'foreignNationalId' => 'индентификатор ИГ',
        'surname' => 'фамилия',
        'name' => 'имя',
        ...
        'attemptAnswer' => 'ответ на попытку',
        'contain'=> 'содержание',
        'fipiGuid'=>'идентификатора фипи',
        'password'=>'пароль',
        'isCorrect' => 'верный',
        'taskVariantId'=> 'идентификатор варианта задания',
        'mark' => 'балл',
        'address' => 'адрес',
        'sublockId' => 'подблока',
